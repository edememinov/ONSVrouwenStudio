<html>
    ...
    <body>
        ...
        <div class="adres">
            <ul class="ac">
                <li class="achl">Activiteiten</li>
                <li class="activiteitenlijst">Naailes</li>
                <li class="activiteitenlijst">Nederlandse les</li>
                <li class="activiteitenlijst">Arabische les</li>
                <li class="activiteitenlijst">Fietsles</li>
                <li class="activiteitenlijst">Sport en bewegen</li>
                <li class="activiteitenlijst">Kleding reparatie</li>
                <li class="activiteitenlijst">Massage</li>
                <li class="activiteitenlijst">Trouwjurken te huur</li>
                <li class="activiteitenlijst">Naai opdrachten</li>
                <li class="activiteitenlijst">Ontbijt voor 1 euro</li>
                <li class="activiteitenlijst">Voorlichtingen</li>
                <li class="activiteitenlijst">Koken</li>
            </ul>
        </div>

        <div class="parkeren">
            <h1 class="titel">Informatie</h1>
            <p>
                Voor info over tijd en locatie van de activiteiten kunt u contact opnemen of altijd vrijblijvend binnenlopen bij ONS vrouwencooperatief.
            </p>
            <p><a href="contact.php">Locatie</a></p>
        </div>
